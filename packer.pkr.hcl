...
source "qemu" "windows_11" {
  ...
  disk_size            = "50000"
  floppy_files         = ["Autounattend.xml", "redhat.cer", "scripts/microsoft-updates.ps1", "scripts/openssh.ps1", "scripts/configureRemotingForAnsible.ps1", "scripts/spiceToolsInstall.ps1", "scripts/fixnetwork.ps1"]
  format               = "raw"
  headless             = "true"
